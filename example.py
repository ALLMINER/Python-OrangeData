...
def main():
    ...
    client.create_correction(
        ...
        0,
        # tax1Sum 1102, сумма НДС чека по ставке 20% Десятичное число с точностью до 2 символов после точки
        0,
        ...
        0,
        # tax5Sum 1106, сумма НДС чека по расч. ставке 20/120 Десятичное число с точностью до 2 символов после точки
        0,
